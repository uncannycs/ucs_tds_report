...
class TDSReportWizard(models.TransientModel):
    ...
    def action_generate_excel_report(self):
        ...
        query = """
            ...
            LEFT JOIN l10n_in_pan_entity pe ON rp.l10n_in_pan_entity_id = pe.id
        ...
        summary_sheet.merge_range('A1:E1', company_name, title_format)
        ...
        for month_key in sorted_month_keys:
            ...
            # Titles
            month_sheet.merge_range('A1:H1', company_name, title_format)
